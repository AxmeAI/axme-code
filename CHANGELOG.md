...
- **Regression coverage**: 42 new tests plus a `self-test` check that round-trips two non-Latin titles and asserts both are readable back under distinct filenames.
